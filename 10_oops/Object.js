...
console.log(multiplyBy5.power); // 2  (prototypal inheritance)
console.log(multiplyBy5.prototype); // {}  (by default context set hote h -> uss method ka this)
...
createUser.prototype.increment = function(){
    this.score++  // jisne bhi bulaya h, uska score increase kro
}
...
// these methods were added to the prototype, so all instances (objects created with new) can use them.
